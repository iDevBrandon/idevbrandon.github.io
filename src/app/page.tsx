                ...
                <div className="flex-1">
                  ...
                  <div className="text-gray-600 space-y-1">
                    <p className="mb-2">
                      ...
                      and markdown documentation from Supabase
                      database.types.ts files
                    </p>
                    <ul className="space-y-1 list-disc list-inside">
                      <li>
                        Parses TypeScript types generated by the Supabase CLI
                        to automatically build ERD diagrams and schema docs
                      </li>
                      <li>
                        Supports multi-schema projects and enhanced foreign
                        key extraction via direct database connection or
                        Supabase API
                      </li>
                      <li>
