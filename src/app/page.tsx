              ...
              <Card>
                ...
                <CardContent>
                  <p className="text-muted-foreground leading-relaxed">
                    ...
                    innovative web solutions. With experience in both frontend
                    and backend development, I enjoy working with modern
                    technologies to build scalable and user-friendly
                    applications.
                  </p>
                </CardContent>
              </Card>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Advanced trading and analytics platform
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <p className="text-muted-foreground mb-4">
                    Comprehensive trading platform with real-time market data,
                    advanced charting, and portfolio management capabilities.
                  </p>
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Financial data and research platform
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <p className="text-muted-foreground mb-4">
                    Financial research platform providing market insights,
                    company analysis, and investment tools for informed decision
                    making.
                  </p>
                  <div className="flex flex-wrap gap-2 mb-4">
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Options market exchange platform
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <p className="text-muted-foreground mb-4">
                    Options trading platform with advanced order management,
                    risk analytics, and real-time market data for professional
                    traders.
                  </p>
                  <div className="flex flex-wrap gap-2 mb-4">
                    <Badge variant="secondary">React</Badge>
